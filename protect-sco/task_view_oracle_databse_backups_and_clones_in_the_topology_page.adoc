...
或者，您也可以参考 https://library.netapp.com/ecm/ecm_download_file/ECMLP2885486["《 SnapCenter 软件命令参考指南》"^] 或 https://docs.netapp.com/us-en/snapcenter-cmdlets-48/index.html["《 SnapCenter 软件 cmdlet 参考指南》"^]。
